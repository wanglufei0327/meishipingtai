			...
			<el-form class="center-form-pv" :style='{"width":"10%","padding":"0 20px","margin":"0 0 20px 0","background":"#fff"}' :inline="true" :model="searchForm">
				<el-row :style='{"alignItems":"center","flexDirection":"column","display":"flex"}' >
					<div :style='{"width":"100%","margin":"0","flexDirection":"column","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">店铺名称</label>
						<el-input v-model="searchForm.dianpumingcheng" placeholder="店铺名称" clearable></el-input>
					</div>
					<div :style='{"width":"100%","margin":"0","flexDirection":"column","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","textAlign":"center","display":"inline-block","width":"100%","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">店铺地址</label>
				...
				<el-row :style='{"margin":"20px 0","alignItems":"center","flexDirection":"column","display":"flex"}'>
					<el-button :style='{"border":"1px solid ","cursor":"pointer","padding":"0 24px","margin":"0 0 6px","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"100%","fontSize":"14px","height":"40px"}' v-if="isAuth('dianpuxinxi','新增')" type="success" @click="addOrUpdateHandler()">新增</el-button>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='false' prop="dianputupian" width="200" label="店铺图片">
						<template slot-scope="scope">
							<div v-if="scope.row.dianputupian">
								<img v-if="scope.row.dianputupian.substring(0,4)=='http'" :src="scope.row.dianputupian.split(',')[0]" width="100" height="100">
								<img v-else :src="$base.url+scope.row.dianputupian.split(',')[0]" width="100" height="100">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"1px solid","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#857EF0","borderRadius":"0","background":"#fff","borderImage":"linear-gradient(180deg, rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 1), rgba(133.00000727176666, 126.00000008940697, 240.00000089406967, 0.10000000149011612)) 1 1","width":"auto","fontSize":"14px","height":"32px"}' v-if=" isAuth('dianpuxinxi','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>

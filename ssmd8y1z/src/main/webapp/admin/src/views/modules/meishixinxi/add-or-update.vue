<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="美食编号" prop="meishibianhao">
					<el-input v-model="ruleForm.meishibianhao" placeholder="美食编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.meishibianhao" label="美食编号" prop="meishibianhao">
					<el-input v-model="ruleForm.meishibianhao" placeholder="美食编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="美食名称" prop="meishimingcheng">
					<el-input v-model="ruleForm.meishimingcheng" placeholder="美食名称" clearable  :readonly="ro.meishimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="美食名称" prop="meishimingcheng">
					<el-input v-model="ruleForm.meishimingcheng" placeholder="美食名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="美食分类" prop="meishifenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.meishitupian" label="美食图片" prop="meishitupian">
					<file-upload
						tip="点击上传美食图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.meishitupian" label="美食图片" prop="meishitupian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="美食口味" prop="meishikouwei">
					<el-input v-model="ruleForm.meishikouwei" placeholder="美食口味" clearable  :readonly="ro.meishikouwei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="美食口味" prop="meishikouwei">
					<el-input v-model="ruleForm.meishikouwei" placeholder="美食口味" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="美食地点" prop="meishididian">
					<el-input v-model="ruleForm.meishididian" placeholder="美食地点" clearable  :readonly="ro.meishididian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="美食地点" prop="meishididian">
					<el-input v-model="ruleForm.meishididian" placeholder="美食地点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="美食价格" prop="meishijiage">
					<el-input v-model="ruleForm.meishijiage" placeholder="美食价格" clearable  :readonly="ro.meishijiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="美食价格" prop="meishijiage">
					<el-input v-model="ruleForm.meishijiage" placeholder="美食价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="美食特色" prop="meishitese">
					<el-input v-model="ruleForm.meishitese" placeholder="美食特色" clearable  :readonly="ro.meishitese"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="美食特色" prop="meishitese">
					<el-input v-model="ruleForm.meishitese" placeholder="美食特色" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="美食介绍" prop="meishijieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.meishijieshao" label="美食介绍" prop="meishijieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.meishijieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.meishijieshao = this.ruleForm.meishijieshao.replace(reg,'../../../ssmd8y1z/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
